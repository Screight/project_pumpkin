...
{
    ENEMY_HIT, ENEMY_KILL, FIREBALL, PILAR, ARCHER_ATTACK, PLAYER_ATTACK_1, PLAYER_ATTACK_2, PLAYER_ATTACK_3, LOW_HP, GROUNDBREAKER, ITEM_PICK_UP, DASH, ARROW, EGG_CRACK_1, EGG_CRACK_2, SPIDER_BOSS_LOSE_LEG, SPIDER_BOSS_CRY, SPIDER_BOSS_CRY_LITE, DRILL_HIT_1, DRILL_HIT_2, DRILL_ATTACK, DRILL_STUCKED, URA_HIT_1, URA_HIT_2, URA_HIT_3, URA_HIT_4, JUMP, RESPAWN, DIALOGUECLIC1, DIALOGUECLIC2, BUTTONSWITCH, BUTTONCLICKED, PORTALUSE, PORTALOPEN, PORTALLOOP, PORTALCLOSE, RUNESFX, SAVESFX, LAST_NO_USE
}