...
public enum PLAYER_STATE { IDLE, MOVE, DASH, JUMP, FALL, BOOST, LAND, ATTACK, DEATH, CAST, GROUNDBREAKER, HURT, LAST_NO_USE }
public enum ENEMY_STATE { IDLE, PATROL, CHASE, ATTACK, HIT, DEATH, REST, CHARGE, LAST_NO_USE}
