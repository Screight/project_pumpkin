...
public enum BACKGROUND_CLIP { MAINTITLE, FORESTOFSOULS, ABANDONEDMINE, SPIDER_BOSS,SAMAELTHEME, LAST_NO_USE }
public enum SCENE { MAIN_MENU, GAME, CREDITS }
...
public enum AudioClipName
{
    ...
    SAMAEL_WHISPER_1, SAMAEL_WHISPER_2, SAMAEL_WHISPER_3, SAMAEL_WHISPER_4,
    SAMAEL_FB_NOISE, SAMAEL_FB_HIT, SAMAEL_FB_SPAWN_1, SAMAEL_FB_SPAWN_2, SAMAEL_CIRCLE_SPAWN_1, SAMAEL_CIRCLE_SPAWN_2,
    SAMAEL_HORIZ_1, SAMAEL_HORIZ_2, SAMAEL_HORIZ_3,
    SAMAEL_HITTED_1, SAMAEL_HITTED_2, SAMAEL_LOSE_EYE, SAMAEL_LOSE_ALL_EYES,
    LAST_NO_USE
}